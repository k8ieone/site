...
You'll find me on most sites under the handle **k8ie**, and occasionally as **k8ieone**.

If you use PGP to encrypt things, [here's](/pubkey.asc) my public key.
...
- GitHub: [k8ieone](https://github.com/k8ieone)
- GitLab: [k8ie](https://gitlab.com/k8ie)
- Codeberg: [k8ie](https://codeberg.org/k8ie)
- postmarketOS wiki: [K8ie](https://wiki.postmarketos.org/wiki/User:K8ie)
